        ...
        if template_values['user'] == '' or template_values['user'] is None:
            ...
            if action.lower() == 'search':
                ...
                if len(user_name) > 0:
                    ...
                    follow_info_key = ndb.Key(FollowUser, user_name)
                ...
                follow_to_info_key = ndb.Key(FollowUser, current_user)
                get_follow_to_info = follow_to_info_key.get()
                follow_to_model = FollowUser()
                ...
                follow_by_info_key = ndb.Key(FollowUser, search_user)
                get_follow_by_info = follow_by_info_key.get()
                follow_by_model = FollowUser()
